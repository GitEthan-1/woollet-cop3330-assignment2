...
class AppTest {
	...
	void calculate_returns_correct_months_1() {
		...
		int expected = 129;
		int actual = App.calculate(2000,18,35);
	...
	void calculate_returns_correct_months_2() {
		...
		int expected = 70;
		int actual = App.calculate(5000, 12, 100);
	...
	void calculate_returns_correct_months_3() {
		...
		int expected = 45;
		int actual = App.calculate(10000,50,500);
	...
	void calculate_returns_correct_months_4() {
		...
		int expected = 11;
		int actual = App.calculate(1234,12.3456,123);
	...
	void calculate_returns_correct_months_5() {
		...
		int expected = 213;
		int actual = App.calculate(1000,10 ,10);
